...
export const functions = [
  {
    name: "insert_styles",
    description:
      "Inserts advanced, responsive CSS styles into the Shopify theme.",
    parameters: {
      type: "object",
      properties: {
        code: {
  ...
  },
  {
    ...
    description:
      "Inserts advanced HTML and Liquid code into the Shopify theme.",
    parameters: {
      type: "object",
      properties: {
        code: {
  ...
  },
  {
    name: "insert_schema",
    description:
      "Inserts advanced schema settings into the Shopify theme for more customization options.",
    parameters: {
      type: "object",
      properties: {
        code: {
